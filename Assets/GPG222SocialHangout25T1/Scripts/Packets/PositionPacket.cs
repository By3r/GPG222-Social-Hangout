...
namespace Networking.Packets
{
    public class PositionPacket : BasePacket
    {
        ...
        public PositionPacket(PlayerData playerData, string objectID, Vector3 position, Quaternion rotation, bool isPhysics = false) : base(PacketType.Position,
            playerData)
        {
